...
query = """
    WITH vila as ( 
        ...
        FROM csv_table
        WHERE
            `NUMERO DO CONTRIBUINTE` LIKE '169%' 
            OR `NUMERO DO CONTRIBUINTE` LIKE '171%' 
            OR `NUMERO DO CONTRIBUINTE` LIKE '170%' 
            OR `NUMERO DO CONTRIBUINTE` LIKE '301%' 
            OR `NUMERO DO CONTRIBUINTE` LIKE '087%' 
            OR `NUMERO DO CONTRIBUINTE` LIKE '103%' 
            OR `NUMERO DO CONTRIBUINTE` LIKE '165%' 
            OR `NUMERO DO CONTRIBUINTE` LIKE '122%' 
            OR `NUMERO DO CONTRIBUINTE` LIKE '166%' 
            OR `NUMERO DO CONTRIBUINTE` LIKE '183%'
...
result.toPandas().to_csv("vila_das_belezas.csv", header=True, encoding='utf-8-sig')
